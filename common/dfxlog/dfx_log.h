...
#define DFXLOGD(fmt, ...) \
    HILOG_BASE_DEBUG(LOG_CORE, fmt, ##__VA_ARGS__)
#else
#define DFXLOGD(fmt, ...)
#endif
#define DFXLOGI(fmt, ...) \
    HILOG_BASE_INFO(LOG_CORE, fmt, ##__VA_ARGS__)
#define DFXLOGW(fmt, ...) \
    HILOG_BASE_WARN(LOG_CORE, fmt, ##__VA_ARGS__)
#define DFXLOGE(fmt, ...) \
    HILOG_BASE_ERROR(LOG_CORE, fmt, ##__VA_ARGS__)
#define DFXLOGF(fmt, ...) \
