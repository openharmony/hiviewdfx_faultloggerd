...
int32_t RequestLimitedPipeFd(const int32_t pipeType, const int32_t timeout, int* pipeFd)
{
#ifndef is_ohos_lite
...
int32_t RequestLimitedDelPipeFd()
{
#ifndef is_ohos_lite
    LitePerfFdRequestData request;
    request.head.clientType = PIPE_FD_LIMITED_CLIENT;
